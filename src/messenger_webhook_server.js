...
function reply(message, state) {
  ...
  if (state.lastQuote && !selectedId && !comboChoice && isFinalTotalFollowup(message)) {
  ...
  if (category === "scissor_lift" && !selectedId) {
    return preserveContext(state, {
      text:
  ...
  if (category === "boom_lift" && !selectedId) {
    return preserveContext(state, {
  ...
  if (category === "excavator" && !selectedId) {
    return preserveContext(state, {
  ...
  if (category === "skid_steer" && !selectedId) {
    return preserveContext(state, {
  ...
  if (category === "telehandler" && !selectedId) {
    return preserveContext(state, {
  ...
  if (category === "forklift" && !selectedId) {
    return preserveContext(state, {
  ...
  if (category === "pressure_washer" && !selectedId) {
    return preserveContext(state, {
